                    ...
                    <div class="body">
                        <form action="{{ route('updateSafe') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" name="name" value="{{ old('name', $safe->name) }}" id="name"
                                        class="form-control">
                            ...
                            <div class="form-group ">
                                <div class="form-line focused">
                                    <input type="number" step=".01" name="total_amount"
                                        value="{{ old('name', $safe->total_amount) }}" id="total_amount"
                                        class="form-control">
                            ...
                            <center><button type="submit"
                                    class="btn btn-primary m-t-15 waves-effect ">{{ __('website.button_update') }}</button>
                            </center>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <button type="button" class="btn btn-info header-dropdown" data-toggle="modal"
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody id="work-table">
                                        @include('website.safe.components.safe_transactions_table',['safeTransactions' =>
                                        $safeTransactions])
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('storeTransaction') }}" method="POST" id="transaction-form"
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" step=".01" name="transaction_amount"
                                            value="{{ old('transaction_amount') }}" id="transaction_amount"
                                            class="form-control">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" name="transaction_reason" value="{{ old('transaction_reason') }}"
                                            id="transaction_reason" class="form-control">
                                        <label class="form-label">{{ __('سبب عملية التحويل') }}</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
