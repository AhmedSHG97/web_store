<head>
    ...
    <link href="{{asset('website')}}/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css" rel="stylesheet">
    ...
    <link href="{{asset('website')}}/css/themes/all-themes.css" rel="stylesheet" />
</head>
