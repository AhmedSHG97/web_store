...
<body class="fp-page">
    <div class="fp-box">
        ...
        <div class="card">
            ...
            @endif
            <div class="body">
                <form action="{{ route('resetPassword') }}" id="forgot_password" method="POST">
                    {{ csrf_field() }}
                    <div class="msg">
                        {{ __("auth.text_forgot_password_illustration") }}
                    </div>
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="email" class="form-control" name="email" placeholder="{{ __('auth.text_email') }}" required autofocus>
                        </div>
                    </div>
